...
begin
    while items /= <<>> do
        ...
        if curr.type = "recycle"
            ...
            capacity.recicle := capacity.recycle - curr.size;
...
\* BEGIN TRANSLATION (chksum(pcal) = "f62adaf1" /\ chksum(tla) = "5b958e57")
               ...
               THEN /\ curr' = Head(items)
                    ...
                    /\ IF curr'.type = "recycle"
                          ...
                          THEN /\ bins' = [bins EXCEPT !.recycle = bins.recycle \union {curr'}]
                               /\ capacity' = [capacity EXCEPT !.recicle = capacity.recycle - curr'.size]
...
\* Last modified Sat May 11 23:07:44 JST 2024 by 81902
