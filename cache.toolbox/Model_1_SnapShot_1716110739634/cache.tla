...
\* BEGIN TRANSLATION (chksum(pcal) = "84c196ff" /\ chksum(tla) = "bed11be5")
...
Tick == /\ pc["time"] = "Tick"
        ...
        /\ UNCHANGED << resource_cap, resources_left, reserved, 
                        resources_needed >>
...
\* Last modified Sun May 19 18:25:35 JST 2024 by 81902
