...
\* BEGIN TRANSLATION (chksum(pcal) = "4822053c" /\ chksum(tla) = "4d9cf48a")
...
Lbl_1 == /\ pc = "Lbl_1"
         /\ Assert(BestKnapsack(itemset) \in ValidKnapsacks(itemset), 
                   "Failure of assertion at line 128, column 5.")
         /\ pc' = "Done"
         /\ UNCHANGED itemset
...
\* Last modified Sun May 12 22:43:39 JST 2024 by 81902
